 ...
 */
final class Version20231102174030 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE guitar DROP is_stored');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE guitar ADD is_stored TINYINT(1) NOT NULL');
    }
}
